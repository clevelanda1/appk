...
const CardScreen: React.FC<CardScreenProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 w-full text-center flex flex-col items-center space-y-2.5">
        <p className="text-gray-400/30 text-xs font-medium">Swipe up to edit request </p>
        <p className="text-gray-500/30 mb-[5px] text-xs font-medium">Tap card to change design & hold to save</p>
        
        <div className="mt-4 w-32 h-1 bg-white/20 rounded-full"></div>
      </div>
