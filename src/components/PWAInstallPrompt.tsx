          ...
          <div className="px-6 pb-6">
            ...
            <div className="space-y-3">
              {platform === 'android' && deferredPrompt ? (
                ...
                <button
                  onClick={onClose}
                  className="w-full bg-blue-600 hover:bg-blue-600 active:bg-blue-700 text-white py-3.5 px-4 rounded-xl transition-all duration-200 font-semibold focus:outline-none text-base"
                  style={{
                    boxShadow: '0 1px 3px rgba(59, 130, 246, 0.4)'
                  }}
                >
